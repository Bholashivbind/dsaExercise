# Function to find the maximum profit earned by bying and selling shares any number of times
def findMaxProfit(price):
    # keep track of the maximum profit gained 
    profit=0

    # initialize the local minimum to the first elements index 
    j= 0

    # start from the second element
    for i in range(1,len(price)):

        # update the local minimum if a decresing sequence is found 
